...
func init() {
	...
	utilruntime.Must(crewv1beta1.AddToScheme(scheme))
...
func main() {
	...
	flag.StringVar(&metricsAddr, "metrics-addr", ":9080", "The address the metric endpoint binds to.")
	...
	mgr, err := ctrl.NewManager(config, ctrl.Options{
		...
		LeaderElectionID:   "aefd3536.example.org",
	})
	if err != nil {
	...
	if err = (&crewv1beta1.Frigate{}).SetupWebhookWithManager(mgr); err != nil {
